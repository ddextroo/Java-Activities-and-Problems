...
public class InterfaceOOP {
    public static void main(String[] args) {
        String name = "Dexter";
        Bank bank = new Bank();
        Account savingsAccount = bank.createAccount(AccountType.SAVINGS, 1200.0, 1.25, name);
        Account currentAccount = bank.createAccount(AccountType.CURRENT, 1500.0, 1000.0, name);
